...
export default function Review() {
  ...
  const getTotalPage = () => {
    Axios.get("https://luanvan-server-1.herokuapp.com/admin/review/get-total-user-review", {
      page: page,
    }).then((res) => {
  ...
  const getReviews = () => {
    Axios.post("https://luanvan-server-1.herokuapp.com/admin/review/get-user-review", {
      page: page,
    }).then((res) => {
      setReviews(res.data);
    });
  ...
  const deleleReview = (review_id) => {
    Axios.post("https://luanvan-server-1.herokuapp.com/admin/review/delete-user-review", {
      review_id: review_id,
    }).then((res) => {
      getReviews();
    });
